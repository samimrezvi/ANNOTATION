...
const DEMO = [
  ...
  {
    name: "Riya Patel",
    email: "riya@medlab.in",
    password: "annotate1",
    role: "annotator",
  },
  {
    name: "Arun Nair",
    email: "arun@medlab.in",
    password: "review99",
    role: "reviewer",
  },
] as const;
    ...
    <div className="login-page">
      <div className="login-card">
        ...
        <p className="login-subtitle">
          Collaborative Biomedical Annotation Platform
        </p>
        ...
        <div className="demo-users">
          {DEMO.map((u) => (
            <button
              ...
              disabled={loading}
            >
              <span className="demo-role-badge" data-role={u.role}>
                {u.role}
              </span>
        ...
        <p className="login-note">
          Credentials are verified by the backend. Start the server before
          logging in.
        </p>
      </div>
    </div>
